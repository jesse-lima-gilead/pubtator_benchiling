...
class PubMedBioCConverter:
    ...
    def fetch_data(self, article_id):
        ...
        if title is None or abstract is None or body is None:
            print(f"Article {article_id} does not have title, abstract or body.")
            return None
    ...
    def convert_to_bioc(self, pubmed_data):
        ...
        for article in root.findall(".//article"):
            ...
            title = self.extract_text_content(article, ".//title-group/article-title")
            abstract = self.extract_text_content(article, ".//abstract")
            authors = []
    ...
    def write_bioc_to_xml(self, pubmed_collection):
    ...
    def run(self, query, start_date=None, end_date=None, retmax=50):
        ...
        print(f"Total missing articles: {missing_count}")
        self.write_bioc_to_xml(pubmed_collection)
...
if __name__ == "__main__":
    ...
    converter.run(query="lung cancer", start_date="2019", end_date="2023")
