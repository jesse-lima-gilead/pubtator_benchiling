...
from src.data_ingestion.ingest_apollo.ingest_xlsx.table_keyword_extractor import extract_table_keywords
...
def process_tables(
    ...
    for idx, table in enumerate(soup.find_all("table")):
        ...
        article_table_id, table_name = f"Extracted_Table_{idx}", f"{source_filename}_{idx}"
