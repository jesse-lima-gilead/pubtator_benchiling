...
from src.data_ingestion.ingest_apollo.ingest_docx.apollo_articles_preprocessor import (
    convert_apollo_to_html,
    extract_tables_from_apollo_html,
)

from src.data_ingestion.ingest_apollo.ingest_docx.apollo_doc_articles_uploader import (
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="Example: python3 -m src.data_ingestion.ingest_apollo.ingest_docx.articles_ingestor --workflow_id workflow1 --source apollo",
    )
    ...
    apollo_ingestor = apolloDOCXIngestor(
