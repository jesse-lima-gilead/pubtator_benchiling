...
def extract_metadata_from_path(full_path, file_uuid):
    ...
    return {
        ...
        "filename_dates": filename_date_matches,
        "filename_primary_date_raw": filename_primary_date_raw,
        "filename_primary_date_iso": filename_primary_date_iso,
        "raw_date_matches": [d["raw"] for d in date_matches] if date_matches else None,
